...
<html>
 ...
 <div class="jumbotron"
 style="border-radius:1; background:url('images/3.jpg'); background-size:cover; height:500px;"></div>
   <div class="container-fluid">
    <div class="row">
        <div class="col-md-3">
         <div class="list-group">
                <a href="" class="list-group-item active">Our Members</a>
                <a href="trainer_details.php" class="list-group-item">Member Details</a>
                <a href="package.php" class="list-group-item">Availability Of Packages In Details</a>
                <a href="payment.php" class="list-group-item">Payments</a>
            </div>
            <hr>
            <div class="list-group">
              <a href="trainer.php" class="list-group-item active">Expert Trainer</a>
     ...
     <div class="card-body" style="background-color:#3498DB;color:FFFFFF;">
                <h3>Registration Form For New Members</h3>
                </div>
